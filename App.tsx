    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 font-sans selection:bg-red-600 selection:text-white">
      ...
      <footer className="bg-black text-gray-400 py-12 border-t border-gray-900">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            {/* Logo im Footer */}
            <div className="w-6 h-6 rounded bg-black border border-gray-800 flex items-center justify-center">
              <span className="text-red-600 font-black text-sm font-display leading-none mt-0.5">M</span>
            </div>
